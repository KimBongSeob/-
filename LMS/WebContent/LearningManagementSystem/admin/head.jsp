        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <ul class="nav navbar-nav side-nav" id="test">
                    ...
                    <li>
                        <a href="/LMS/LearningManagementSystem/Subject.do"><i class="glyphicon glyphicon-book"></i>&nbsp 과목관리</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="/LMS/LearningManagementSystem/AdminSpecialty.do"><i class="glyphicon glyphicon-book"></i>&nbsp 부/복수전공 관리</a>
                    </li>
