        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav" id="test">
                    <li>
                        <a href="/LMS/LearningManagementSystem/professor/ProfessorFrom.do"><i class="fa fa-fw fa-edit"></i> 개인정보 </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="/LMS/LearningManagementSystem/ClassPlanForm.do"><i class="glyphicon glyphicon-book"></i>&nbsp 강의계획서 관리 </a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
