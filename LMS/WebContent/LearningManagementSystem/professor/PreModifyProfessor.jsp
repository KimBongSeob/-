        ...
        <div class="panel-body">
          <div class="row">
            <div class="col-lg-12">
              ...
              <form id="Pre_modifyform" action="/LMS/LearningManagementSystem/professor/PreModifyProProfessor.do?" method="post" name="myform" role="form" style="display: block;" onSubmit="return checkIt()">
