...
<%@include file="/LearningManagementSystem/professor/head_professor.jsp"%>
	...
	<center>
		<form method="post" name="writeform" action="/LMS/LearningManagementSystem/professor/commonProfessor/MVC/writePro.do" enctype="multipart/form-data" onsubmit="return writeSave()">
			...
			<table width="700" border="1" cellspacing="0" cellpadding="0" align="center">
				<tr>
					...
					<a href="/LMS/LearningManagementSystem/professor/commonProfessor/MVC/list.do"> 글목록</a></td>
				</tr>
