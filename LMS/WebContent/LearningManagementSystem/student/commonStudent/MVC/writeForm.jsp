...
<body>
	<center>
		...
		<form method="post" name="writeform" action="/LMS/LearningManagementSystem/student/commonStudent/MVC/writePro.do" enctype="multipart/form-data" onsubmit="return writeSave()">
