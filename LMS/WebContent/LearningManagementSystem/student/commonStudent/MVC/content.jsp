			...
			<table width="700" border="1" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td colspan="4" bgcolor="${value_c}" align="right"><input
						...
						onclick="document.location.href='/LMS/LearningManagementSystem/student/commonStudent/MVC/updateForm.do?num=${article.num}&pageNum=${pageNum}'">
						&nbsp;&nbsp;&nbsp; <input type="button" value="글삭제"
						onclick="document.location.href='/LMS/LearningManagementSystem/student/commonStudent/MVC/deleteForm.do?num=${article.num}&pageNum=${pageNum}'">
						&nbsp;&nbsp;&nbsp; <input type="button" value="답글쓰기"
						onclick="document.location.href='/LMS/LearningManagementSystem/student/commonStudent/MVC/writeForm.do?num=${article.num}&ref=${article.ref}&re_step=${article.re_step}&re_level=${article.re_level}'">
						&nbsp;&nbsp;&nbsp; <input type="button" value="글목록"
						onclick="document.location.href='/LMS/LearningManagementSystem/student/commonStudent/MVC/list.do?pageNum=${pageNum}'">
					</td>
				</tr>
			</table>
		</form>
