				...
				<div class="row">
							...
							<table style='float: right;'>
								...
								<tr>
									<td align="right" bgcolor="${value_c}"><a
										href="/LMS/LearningManagementSystem/student/noticeboard/list.do">More</a></td>
									...
									<c:forEach var="article" items="${articleList}">
										...
										<tr height="30">
											...
											<td align="center" width="50"><a
												href="/LMS/LearningManagementSystem/student/noticeboard/content.do?num=${article.num}&pageNum=${currentPage}">
					...
					<div class="col-lg-5 text-center">
						...
						<table style='float: right'>
							<tr>
								<td align="right" bgcolor="${value_c}"><a
									href="/LMS/LearningManagementSystem/student/commonStudent/MVC/list.do">More</a></td>
							</tr>
						</table>
								...
								<c:forEach var="article" items="${articleList2}">
									...
									<tr height="30">
										...
										<td width="250"><c:if test="${article.re_level > 0}">
											...
											href="/LMS/LearningManagementSystem/student/commonStudent/MVC/content.do?num=${article.num}&pageNum=${currentPage}">${article.subject}</a>
