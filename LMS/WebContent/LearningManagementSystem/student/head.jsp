        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
          ...
          <ul class="nav navbar-right top-nav">
                <li>
                 ...
                 <li>
                    <a href="/LMS/LearningManagementSystem/student/commonStudent/MVC/list.do"><i class="fa fa-bell"></i>&nbsp 게시판 <b class="caret"></b></a>                    
                </li>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <ul class="nav navbar-nav side-nav" id="test">
                    <li class="">
                        <a href="/LMS/LearningManagementSystem/PreModify.do"><i class="glyphicon glyphicon-user"></i>&nbsp 개인정보</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#result_target"><i class="glyphicon glyphicon-book"></i>&nbsp 성적조회 <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="result_target" class="collapse">
                            <li>
                                <a href="/LMS/LearningManagementSystem/result.do?check=1">전체 성적 조회</a>
                            </li>
                            <li>
                                <a href="/LMS/LearningManagementSystem/result.do?check=2">학기별 성적 조회</a>
                            </li>
                        </ul>
                    </li>
                    <li>
...
<li>
<a href="/LMS/LearningManagementSystem/SelectTimetable.do"><i class="glyphicon glyphicon-calendar"></i>&nbsp 시간표조회</a>
</li>     
